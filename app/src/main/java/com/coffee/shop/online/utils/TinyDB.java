...
public class TinyDB {
    ...
    public ArrayList<ItemsDTO> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ItemsDTO> playerList = new ArrayList<ItemsDTO>();

        for (String jObjString : objStrings) {
            ItemsDTO player = gson.fromJson(jObjString, ItemsDTO.class);
    ...
    public void putListObject(String key, ArrayList<ItemsDTO> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ItemsDTO player : playerList) {
